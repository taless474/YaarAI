"""
Normalize directive framing in beyt_hints.
...
from beyt_hint fields, preserving the remaining noun phrase.

No regeneration, no semantic reinterpretation.
A new annotation version (v1.3) is written.

Input:
  data/annotations/beyt_annotations_v1_2.jsonl

Output:
  data/annotations/beyt_annotations_v1_3.jsonl
"""
...
IN_PATH = Path("data/annotations/beyt_annotations_v1_2.jsonl")
OUT_PATH = Path("data/annotations/beyt_annotations_v1_3.jsonl")
...
def main():
    ...
    print(f"Normalized {changed} beyt_hints")
